...
<div class="col-md-12 col-print-12 invoice-info">
    ...
    <div class="col-md-4 col-print-4 panel-card">
        <span class='bolder' style="font-size:15px">Credit Note #: {{ $creditNote->no }}&nbsp;&nbsp;</span><br>
        <span class='bolder' style="font-size:15px">Credit Note Date : {{ $creditNote->created_at->format('m/d/Y H:i') }}</span><br>
        <span class='bolder' style="font-size:15px">Related : Invoice # : {{ $invoice->number }},{{ $invoice->number2 }}</span><br>
